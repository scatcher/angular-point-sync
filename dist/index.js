...
(function (angularPoint) {
    ...
    var apSyncService = (function () {
         ...
         */
        apSyncService.prototype.initialize = function (userId, fireBaseUrl) {
            var self = this;
        ...
        return apSyncService;
    })();
    angularPoint.apSyncService = apSyncService;
    ...
    angular.module('angularPoint').service('apSyncService', apSyncService);
